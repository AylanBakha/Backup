...
*/
	public function getLesFraisHorsForfait($idVisiteur,$mois){
	    $req = "select * from LigneFraisHorsForfait, ModePaiement where LigneFraisHorsForfait.idVisiteur ='$idVisiteur' 
		and LigneFraisHorsForfait.mois = '$mois' and LigneFraisHorsForfait.paiement = ModePaiement.paiement";
    ...
    public function getLesModes(){
        return PdoGsb::$monPdo->query("select * from ModePaiement");
    }
