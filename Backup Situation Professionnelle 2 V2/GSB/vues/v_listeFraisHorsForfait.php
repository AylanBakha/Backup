          ...
          <fieldset>
            ...
            <p>
              ...
              <select name=" "  id=" " required>
			            <?php $reponse = $bdd->query('SELECT paiement FROM "LigneFraisHorsForfait"');
                              while ($donnees = $reponse->fetch())
									{
									?>
					        <option value="<?php echo $donnees['paiement']; ?>"> 
					        <?php echo $donnees['paiement']; ?>
					        </option>
				         	<?php } ?>
		            </select>
              <input type="select" id="txtPaiementHF" name="paiement" value="" from ModePaiement/>
